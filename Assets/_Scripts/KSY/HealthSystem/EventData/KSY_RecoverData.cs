...
namespace KSY.HealthSystem
{
    ...
    public readonly struct KSY_RecoverData
    {
        ...
        public KSY_RecoverData(KSY_Entity giver, int recoverValue)
        {
            this.giver = giver;
            this.recoverValue = recoverValue;
        }
        public static KSY_RecoverData Create(KSY_Entity giver, int recoverValue)
        {
    ...
    public readonly struct KSY_RecoverResultData
    {
        ...
        public KSY_RecoverResultData(KSY_Entity giver, int recoverValue, int resourceData)
        {
            this.giver = giver;
            this.recoverValue = recoverValue;
            this.resourceData = resourceData;
        }
        public static KSY_RecoverResultData Create(KSY_Entity giver, int recoverValue, int resourceData)
        {
